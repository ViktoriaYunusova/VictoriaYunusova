          ...
          <div className="p-5 sm:p-6">
            ...
            <AnimatePresence initial={false}>
              {open && (
                ...
                >
                  <div className="mt-5 max-h-[40svh] overflow-y-auto border-t border-border pt-4 pr-1">
                    <h4 className="mb-3 font-sans text-xs font-bold uppercase tracking-wide text-foreground/70">
